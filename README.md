...
_The case study follows the six step data analysis process: [ask](#business-task), [prepare](#prepare), [process](#process), [analyze](#analyze), [share](#share), and [act](#act)._
...
**2. Indentify unnecessary data and remove those columns:**

```
bike_data <- bike_data %>% select(-c(start_lat, start_lng, end_lat, end_lng))
```

**3. Add two columns: ride length and day of the week:** 
```
